...
export { addTerm, drillExpression, excludingTerm, liftTerm, pressOptions, recordTerm, scopedEntity, scopeTerm, scopeTermFor, termStanding, withoutOwnScope, } from './query/drill';
