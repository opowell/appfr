...
export { andExpression, formatExpression, formatTerm, joinExpression, matchesExpression, parseExpression, sameTerm, splitExpression, withoutTerm, } from './data/expression';
