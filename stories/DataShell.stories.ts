 ...
 * results — choose Sets and there it is, among every other set the query
 * allows: a list of sets does not apply the term naming one of them to
 * itself, though the query keeps it for everything else.
 */
